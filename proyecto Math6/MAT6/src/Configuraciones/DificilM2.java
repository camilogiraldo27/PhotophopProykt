...
import Interfaz.Nivel_Dificil;

import java.awt.event.KeyAdapter;
import java.awt.event.KeyEvent;

public class DificilM2 extends JFrame {
	...
	JScrollPane scrollpane;
	  ...
	  //rsscalelabel.RSScaleLabel.setScaleLabel(label_3, DificilCF.img1);
	  public static AudioClip music;
		
	  public static void main(String args[]) {
			DificilM2 dc = new DificilM2();
			dc.setVisible(true);
	 }
	  ...
	  public DificilM2() {
	    ...
	    setTitle("Nivel Avanzado-Modificado");
	    setSize(1102,600);
	  ...
	  private void alcerrar() {
		  ...
		  if(eleccion==JOptionPane.YES_OPTION) {
			  setDefaultCloseOperation(DificilM2.DISPOSE_ON_CLOSE);
			  JOptionPane.showMessageDialog(null, "Cierra cualquier conometro abierto antes de inciar otro nivel.", "IMPORTANTE", JOptionPane.INFORMATION_MESSAGE);
			  Cronometro  crm = new Cronometro();
				crm.setVisible(false);
				crm.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
	  ...
	  public static void campos_no_vacios(){
		    if(s1.getText().isEmpty()==true || s2.getText().isEmpty()==true || s3.getText().isEmpty()==true || s4.getText().isEmpty()==true || s5.getText().isEmpty()==true ||
		    	    ...
		    	    JOptionPane.showMessageDialog(null, "Revise que ningun campo este vacio.", "Validando Datos",
		    	    		  JOptionPane.INFORMATION_MESSAGE);
		    	}
		    }
	  
	  public static void Captura_de_resultados_area_perimetro_y_longitud(){
	  ...
	  public static void validar_respuestas(){
		  if((p1!=DificilCF.r1 & a1!=DificilCF.r2)||(p2!=DificilCF.r3 & a2!=DificilCF.r4)||(p3!=DificilCF.r5 & a3!=DificilCF.r6)||(p4!=DificilCF.r7 & a4!=DificilCF.r8)||(p5!=DificilCF.r9 & a5!=DificilCF.r10)||(pirata!=DificilCF.r11)||(oso!=DificilCF.r12)||(nina!=DificilCF.r13)){
		         JOptionPane.showMessageDialog(null, "Revise que las respuestas esten correctas recuerda que tienes ayudas, lee bien quizas te sean muy utiles.", "Validando Datos", JOptionPane.WARNING_MESSAGE);
		     }else{
		    	 JOptionPane.showMessageDialog(null, "Respuestas correctas.", "Validando Datos", JOptionPane.INFORMATION_MESSAGE);
  ...
  public void all() {
    ...
    s1.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s1.getText().contains(".")){
    			e.consume();
    	}}
    });
    s1.setEnabled(false);
    ...
    ay1.addMouseListener(new MouseAdapter() {
    	...
    	public void mouseClicked(MouseEvent e) {
    		JOptionPane.showMessageDialog(null, DificilCF.ayc1, "Ayuda",
             		  JOptionPane.INFORMATION_MESSAGE);
    	}
    });
    ay1.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/ayuda2.png")));
    ...
    s2.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s2.getText().contains(".")){
    			e.consume();
    	}}
    });
    s2.setEnabled(false);
    ...
    s3.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s3.getText().contains(".")){
    			e.consume();
    	}}
    });
    s3.setEnabled(false);
    ...
    ay2.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/ayuda2.png")));
    ...
    s4.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s4.getText().contains(".")){
    			e.consume();
    	}}
    });
    s4.setEnabled(false);
    ...
    s5.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s5.getText().contains(".")){
    			e.consume();
    	}}
    });
    s5.setEnabled(false);
    ...
    ay3.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/ayuda2.png")));
    ...
    s6.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s6.getText().contains(".")){
    			e.consume();
    	}}
    });
    s6.setEnabled(false);
    ...
    s7.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s7.getText().contains(".")){
    			e.consume();
    	}}
    });
    s7.setEnabled(false);
    ...
    ay4.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/ayuda2.png")));
    ...
    s8.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s8.getText().contains(".")){
    			e.consume();
    	}}
    });
    s8.setEnabled(false);
    ...
    s10.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s10.getText().contains(".")){
    			e.consume();
    	}}
    });
    ...
    s9.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s9.getText().contains(".")){
    			e.consume();
    	}}
    });
    s9.setEnabled(false);
    ...
    ay5.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/ayuda2.png")));
    ...
    txtpnElPirataBarba.setText(DificilCF.text1);
    ...
    s11.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s11.getText().contains(".")){
    			e.consume();
    	}}
    });
    ...
    ay6.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/ayuda2.png")));
    ay6.setToolTipText("\u00BFNecesitas ayuda?");
    ay6.setFont(new Font("Tahoma", Font.BOLD, 14));
    
    JLabel label_46 = new JLabel("");
    label_46.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/2.jpg")));
    
    JLabel label_47 = new JLabel("");
    label_47.setIcon(new ImageIcon(DificilM2.class.getResource("/imgNA/mate1.jpg")));
    
    btnrespuestas = new JButton("");
    btnrespuestas.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/check.png")));
    btnrespuestas.addActionListener(new ActionListener() {
    	public void actionPerformed(ActionEvent e) {
        campos_no_vacios();
        Captura_de_resultados_area_perimetro_y_longitud();
        validar_respuestas();
    	}
    });
    ...
    btnev3 = new JButton("");
    btnev3.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/enviar.png")));
    ...
    btncronometro.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/cronometro.png")));
    btncronometro.addActionListener(new ActionListener() {
    	public void actionPerformed(ActionEvent e) {
    		music= java.applet.Applet.newAudioClip(getClass().getResource("/Musica/onemoretime.wav"));
			music.loop();
    ...
    s12.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s12.getText().contains(".")){
    			e.consume();
    	}}
    });
    ...
    ay7.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/ayuda2.png")));
    ...
    s13.addKeyListener(new KeyAdapter() {
    	...
    	public void keyTyped(KeyEvent e) {
    		char c = e.getKeyChar();
    		if(!Character.isDigit(c) && s13.getText().contains(".")){
    			e.consume();
    	}}
    });
    s13.setEnabled(false);
    ...
    ay8.setIcon(new ImageIcon(DificilM2.class.getResource("/imagenes/ayuda2.png")));
    ...
    label_54.setIcon(new ImageIcon(DificilM2.class.getResource("/imgNA/longitud.jpg")));
    label_54.setFont(new Font("Tahoma", Font.BOLD, 14));
    
    JLabel label_55 = new JLabel("");
    label_55.setIcon(new ImageIcon(DificilM2.class.getResource("/imgNA/perimetro.jpg")));
    label_55.setFont(new Font("Tahoma", Font.BOLD, 14));
    
    JLabel label_56 = new JLabel("");
    label_56.setIcon(new ImageIcon(DificilM2.class.getResource("/imgNA/pitagoras.jpg")));
    label_56.setFont(new Font("Tahoma", Font.BOLD, 14));
    
    JLabel label_57 = new JLabel("");
    label_57.setIcon(new ImageIcon(DificilM2.class.getResource("/imgNA/area.jpg")));
    				...
    				.addGroup(gl_panel.createSequentialGroup()
    					...
    					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
    						...
    						.addGroup(gl_panel.createSequentialGroup()
    							...
    							.addGap(6)
    							.addComponent(label_47, GroupLayout.PREFERRED_SIZE, 156, GroupLayout.PREFERRED_SIZE)
    							.addGap(383)
    	...
    	gl_panel.createParallelGroup(Alignment.LEADING)
    		.addGroup(gl_panel.createSequentialGroup()
    			...
    			.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
    				...
    				.addComponent(label_47, GroupLayout.PREFERRED_SIZE, 123, GroupLayout.PREFERRED_SIZE)
    				.addGroup(gl_panel.createSequentialGroup()
    					.addGap(50)
    					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
