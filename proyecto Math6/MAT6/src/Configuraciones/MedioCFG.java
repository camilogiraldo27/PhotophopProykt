...
public class MedioCFG extends JFrame {
	...
	File fichero;
	  ...
	  private JTextField txtNotaRecuerdaLlenar;
	...
	public MedioCFG() {
		...
		this.addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent we) {
				  JOptionPane.showMessageDialog(null, "Vuelve a la ventana de configuraciones para editar otro nivel si asi lo deseas.", "IMPORTANTE", JOptionPane.INFORMATION_MESSAGE);
			}
		});
	    ...
	    setTitle("Nivel Medio Configuración");
	    setSize(1102,600);
	...
	public static void  Eliminar_Datos(){
		txtrespuesta1.setText(""); txtrespuesta2.setText(""); txtrespuesta3.setText("");txtrespuesta4.setText("");
		txtrespuesta5.setText("");txtrespuesta6.setText("");txtrespuesta7.setText("");txtrespuesta8.setText("");
		lblimg1.setIcon(null); lblimg2.setIcon(null); lblimg3.setIcon(null); lblimg4.setIcon(null); 
		lblimg5.setIcon(null); lblimg6.setIcon(null); lblimg7.setIcon(null); lblimg8.setIcon(null);
		textPane_5.setText("");textPane_4.setText(""); textPane_3.setText("");textPane_2.setText("");textPane_1.setText("");textPane.setText("");
		txtpane=null;txtpane1=null;txtpane2=null;txtpane3=null;txtpane4=null;txtpane5=null;
	    ayc1=null;ayc2=null;ayc3=null;ayc4=null;ayc5=null;ayc6=null;ayc7=null;ayc8=null;
	...
	private void cerrar_ventana(){
	 ...
	 public void all() {
	   ...
	   btnGuardar = new JLabel("");
	    ...
	    txtNotaRecuerdaLlenar = new JTextField();
	    txtNotaRecuerdaLlenar.setFont(new Font("Bahnschrift", Font.BOLD, 11));
	    txtNotaRecuerdaLlenar.setBackground(Color.WHITE);
	    txtNotaRecuerdaLlenar.setEditable(false);
	    txtNotaRecuerdaLlenar.setText("NOTA: recuerda llenar todo el nivel para poder guradar toda la información.");
	    txtNotaRecuerdaLlenar.setBounds(0, 530, 467, 52);
	    panel_2.add(txtNotaRecuerdaLlenar);
	    txtNotaRecuerdaLlenar.setColumns(10);
